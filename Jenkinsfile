        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/TheReeds/PSD2025-IG1-Jenkins-fork.git'
                }
            }
        }
        stage('Build') {
